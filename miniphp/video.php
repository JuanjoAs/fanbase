            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center section-header">
                        <h2>Jak and Daxter Collection Trailer</h2>
                    </div>
                </div><!-- /row -->
                <div class="row">
                            ...
                            <div class="col-12">
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item"
                                        src="https://www.youtube.com/embed/ShIbfBvNuDM"
                                            ...
                                            <div class="col-11">
                                                <div class="row">
                                                    <form class="col-12">
                                                        ...
                                                        <button type="submit"
                                                            class="btn btn-success mt-2">Comentar</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-4 col-12">
                        ...
                        <div class="row mb-3 tarjeta-video border p-2">
                            <div class="col-5">
                                <div class="row">
                                    <img src="assets/img/trailer/TrailerPersona5Scramble.png" class="img-fluid w-100"
                                        title="usename">
                                </div>
                            </div>
                            <div class="col-7">
