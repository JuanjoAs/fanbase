...
--
-- Servidor: localhost
-- Tiempo de generación: 31-01-2020 a las 14:27:23
...
CREATE TABLE `usuario` (
  ...
  `google_id` longtext CHARACTER SET utf8 COLLATE utf8_spanish2_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `usuario` (`id`, `usuario`, `nombre`, `email`, `password`, `rango`, `texto`, `activo`, `imagen`, `google_id`) VALUES
...
(2, 'rafa', 'Rafael', 'rafa@fanbase.com', '81dc9bdb52d04dc20036dbd8313ed055', 'admin', 'eooo', 1, '', ''),
(3, 'juanjo', 'Juanjo', 'juanjo@fanbase.com', '81dc9bdb52d04dc20036dbd8313ed055', 'user', '', 1, '', ''),
(4, '  Francisco', 'Francisco Trillo', 'trenderx@gmail.com', '', 'user', 'uwu', 1, 'https://lh3.googleusercontent.com/a-/AAuE7mA8si-XtZTGS6nRBVVsXvn8PNn54ct0x0xZZaqH', '111698427436074869438');
